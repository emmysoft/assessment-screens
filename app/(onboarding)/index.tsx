...
const index = () => {
    return (
        <View style={tw`flex-1 justify-center items-center gap-5 p-4 bg-[#020912]`}>
            ...
            <TouchableOpacity onPress={() => router.push('(page)')} style={tw`rounded-md flex flex-row justify-center items-center px-12 py-3 bg-[#FB5521]`}>
            ...
            <TouchableOpacity onPress={() => router.push('(profile)')} style={tw`rounded-md flex flex-row justify-center items-center px-3 py-2 bg-[#FFFFFF]`}>
